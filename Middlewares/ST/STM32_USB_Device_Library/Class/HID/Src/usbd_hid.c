...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgFSDesc[USB_HID_CONFIG_DESC_SIZ] __ALIGN_END = {
  ...
  the configuration*/
    ...
    HID_KEY_MOUSE_REPORT_DESC_SIZE, /*wItemLength: Total length of Report descriptor*/
    0x00,
            ...
            switch (req->bRequest) {
                ...
                case USB_REQ_GET_DESCRIPTOR:
                    if (req->wValue >> 8 == HID_REPORT_DESC) {
                        ...
                        len  = MIN(HID_KEY_MOUSE_REPORT_DESC_SIZE, req->wLength);
                        pbuf = HID_KEY_MOUSE_ReportDesc;
